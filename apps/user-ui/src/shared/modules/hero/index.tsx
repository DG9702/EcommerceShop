      ...
      <div className='md:w-[80%] w-[90%] m-auto md:flex h-full items-center'>
        <div className='md:w-1/2'>
          ...
          <button
            ...
            className='w-[140px] gap-2 font-semibold h-[40px] bg-white hover:text-white hover:bg-[#115061] border border-white flex items-center justify-center rounded-md'>
            Shop now <MoveRight  />
          </button>
        </div>
        <div className='md:w-1/2 flex justify-center'>
          <Image
            src={"https://ik.imagekit.io/bigwavehaibuithe/products/ShoppingCart.png?updatedAt=1757342740267"}
            alt=''
            width={450}
            height={450}
          />
