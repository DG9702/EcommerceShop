...
const Signup = () => {
  ...
  console.log("sellerData in signup page: ", sellerData);
      ...
      <div className="md:w-[480px] p-8 bg-white shadow rounded-lg">
        ...
        {activeStep===3&&(
          <div className="text-center">
            ...
            <br />
            <button
              className="w-full m-auto flex items-center justify-between gap-3 text-lg bg-[#334155] text-white p-2 rounded-lg"
