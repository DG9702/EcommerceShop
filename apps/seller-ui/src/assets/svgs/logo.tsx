const Logo = () => {
  return (
    <div className="border border-slate-800 h-[45px] w-[45px] flex items-center justify-center rounded-lg">
      <svg
        viewBox="0 0 36 36"
