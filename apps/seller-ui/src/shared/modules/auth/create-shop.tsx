  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <label className="block text-gra-700 mb-1">Bio (Max 100 words) *</label>
        <input
          type="text"
        ...
        <label className="block text-gra-700 mb-1">Address *</label>
        <input
          type="text"
        ...
        <label className="block text-gra-700 mb-1">Opening Hour *</label>
        <input
          type="text"
          placeholder="e.h., Mon-fri 9AM - 6PM"
          className="w-full p-2 border border-gray-300 outline-0 rounded-[4px] mb-1"
